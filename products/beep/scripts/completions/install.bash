# bash completion for beep install.sh
#
# Usage:
...
_beep_install() {
  ...
  components="beep forgejo forgejo-runner llama"
  ...
  for (( i = 1; i < COMP_CWORD; i++ )); do
    ...
    case "${word}" in
      ...
      beep|forgejo|forgejo-runner|llama)
...
complete -F _beep_install install.sh ./install.sh
