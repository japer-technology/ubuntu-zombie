...
/opt/beep/bin/beep-health           # runtime health
sudo /opt/beep/bin/beep-diagnostics # bundle logs (writes /tmp)
```
...
3. The bundle written by `sudo /opt/beep/bin/beep-diagnostics`
...
Beep is maintained on a best-effort basis. We aim to:
