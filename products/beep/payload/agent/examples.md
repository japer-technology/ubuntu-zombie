# Example requests for Beep

Use these prompts as starting points. Beep is best when you ask
...
- Tell me whether the beep itself is healthy, authenticated, and inside
  its Time to Live.
