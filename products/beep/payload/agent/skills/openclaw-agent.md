...
- Run OpenClaw separately from Beep: a distinct unprivileged user,
  state tree, secrets and service. Never reuse Beep's sudo access,
...
- Review extensions, skills and connectors as executable third-party code.
  ...
  needed. An OpenClaw approval must not stand in for Beep's gate.
